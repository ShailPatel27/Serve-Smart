...
<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        $qry = "select * from accounts where uname = '$inpuname' AND pass = '$inppass'";
        ...
        $query = "select name from accounts where uname = '$inpuname' AND pass = '$inppass'";
        ...
        if(isset($_POST["signed"]))
        {
            ...
            header("Location: ../loggedproject/home.php");
        }
    }
